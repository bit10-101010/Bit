...
template<Bit::Eval::NNUE::IndexType L1, int L2, int L3>
struct std::hash<Bit::Eval::NNUE::NetworkArchitecture<L1, L2, L3>> {
    std::size_t
    operator()(const Bit::Eval::NNUE::NetworkArchitecture<L1, L2, L3>& arch) const noexcept {
